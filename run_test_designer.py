...
if __name__ == "__main__":
    ...
    requirements = {
        ...
        "analysis_result": {
            ...
            "test_scenarios": [{'id': 'TS001', 'description': '测试文件上传功能，包括pdf和图片格式的单个及批量上传', 'test_cases': []}, {'id': 'TS002', 'description': '验证整理结果展示的正确性和多表格展示功能', 'test_cases': []}, {'id': 'TS003', 'description': '测试溯源功能中的来源图片展示是否准确', 'test_cases': []}, {'id': 'TS004', 'description': '检查下载结果的文件格式和命名是否符合要求', 'test_cases': []}],
