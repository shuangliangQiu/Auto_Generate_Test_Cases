...
class TestScenario(BaseModel):
    ...
    test_cases: List[str] = Field(default_factory=list, description="关联的测试用例ID列表")
...
class RequirementAnalysisResponse(AgentMessage):
    ...
    risk_areas: List[str] = Field(default_factory=list, description="风险领域列表")
